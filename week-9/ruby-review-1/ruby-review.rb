# Drawer Debugger
  ...
  # I spent 1.5 hrs on this challenge.
...
=begin # Reflection:
  # What concepts did you review in this challenge?
	Classes, attributes, creating functions, control flow
  
  # What is still confusing to you about Ruby?
	Nothing, we did this all in the first swing; no research, no errors

  # What are you going to study to get more prepared for Phase 1
  	Honestly, probably more javascript
=end
