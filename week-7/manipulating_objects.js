...
I passed a couple of tests only to fail one later because of a previous code I wrote:
// terah = {
//   spouse: adam,
//   weight: 125
//   child:
// }
First, I had this written after my adam var, second it turned out (at least I think) that I was redefining the terah var instead of adding to it.  So I reformatted the code to push changes and everything seemed to work.


(2)How difficult was it to add and delete properties outside of the object itself?

It can be difficult because sometimes it's one has to keep in mind calling changes in a certain order that works with control flow

(3)What did you learn about manipulating objects in this challenge?

That there's a couple of ways we can define objects and push changes withing the variables.  Particularly, we can use dot notation and literal, not just to assign but also manipulate.
